...
export default function App() {
  ...
  return (
    // Added the dark background gradient right here!
    <div className="min-h-screen bg-[#f5f5f7] dark:bg-gradient-to-br dark:from-[#1e1e2f] dark:via-[#13131A] dark:to-[#0d0d12] text-[#1d1d1f] dark:text-[#f4f4f5] font-sans selection:bg-blue-200 dark:selection:bg-blue-900/60 selection:text-blue-900 dark:selection:text-blue-100 antialiased relative overflow-hidden transition-colors duration-500">
      ...
      <div className="absolute top-[-15%] left-[-10%] w-[50%] h-[50%] bg-blue-200/50 dark:bg-white/10 rounded-full filter blur-[100px] md:blur-[120px] pointer-events-none z-0 transition-colors duration-500"></div>
      
      <div className="absolute top-[20%] right-[-10%] w-[30%] h-[40%] bg-purple-200/40 dark:bg-purple-900/30 rounded-full filter blur-[100px] md:blur-[120px] pointer-events-none z-0 transition-colors duration-500"></div>
      {/* -------------------------------------- */}
      ...
      <section id="projects" className="relative z-10 w-full max-w-6xl mx-auto px-6 py-24">
        <FadeIn>
          <div className="text-center mb-20">
            <h2 className="text-4xl md:text-6xl font-bold tracking-tight text-[#1d1d1f] dark:text-white mb-6 transition-colors duration-500">Selected Works.</h2>
            <p className="text-xl md:text-2xl text-[#86868b] dark:text-gray-400 font-medium transition-colors duration-500">A look at the applications I've engineered and worked on.</p>
          </div>
        </FadeIn>
