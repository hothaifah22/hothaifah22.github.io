...
export default function AjeerProject({ onOpenSlider }) {
  return (
    <FadeIn>
      <div className="flex flex-col lg:flex-row items-stretch bg-white/60 backdrop-blur-xl border border-white/50 rounded-[2rem] md:rounded-[3rem] shadow-[0_8px_30px_rgb(0,0,0,0.04)] overflow-hidden">
        <div className="w-full lg:w-1/2 p-6 md:p-16 flex flex-col items-start justify-center">
          ...
          <h3 className="text-3xl md:text-5xl font-bold text-[#1d1d1f] mb-2 md:mb-4 tracking-tight">Ajeer Mobile</h3>
          <p className="text-[#86868b] text-lg md:text-2xl mb-6 font-medium">Home Services Booking App</p>
          ...
          <div className="flex flex-wrap gap-2 md:gap-3 mb-6">
            ...
            <span className="px-3 py-1.5 md:px-4 md:py-2 bg-white text-[#1d1d1f] rounded-full text-xs md:text-sm font-semibold tracking-wide border border-gray-200 shadow-sm">UI/UX Design</span>
          </div>
        ...
        <div className="w-full lg:w-1/2 bg-gradient-to-br from-blue-50 to-blue-100/40 p-8 md:p-16 flex justify-center items-center min-h-[350px] md:min-h-[500px] relative">
          ...
          <button 
            ...
            className="absolute bottom-4 right-4 md:bottom-10 md:right-10 z-20 bg-white/90 backdrop-blur-md border border-gray-200 text-[#1d1d1f] px-4 py-2 md:px-6 md:py-3 rounded-full shadow-[0_8px_30px_rgb(0,0,0,0.12)] font-semibold text-xs md:text-sm flex items-center gap-2 hover:bg-white hover:scale-105 transition-all duration-300"
          >
