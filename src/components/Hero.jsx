...
export default function Hero() {
  return (
    <main className="relative z-10 flex flex-col items-center justify-center px-6 text-center max-w-5xl mx-auto pt-32 md:pt-40 pb-12">
      ...
      <FadeIn delay={200}>
        <div className="inline-block mb-6 md:mb-8 px-4 py-2 md:px-5 rounded-full bg-white/60 border border-gray-200/50 shadow-sm backdrop-blur-md">
          <span className="text-sm md:text-base font-medium text-[#86868b] tracking-wide">Mobile Developer & UI/UX Designer</span>
        </div>
      </FadeIn>
      
      <FadeIn delay={300}>
        <h1 className="text-5xl md:text-[5.5rem] leading-tight font-bold tracking-tight mb-6 md:mb-8 text-[#1d1d1f]">
          Building clean, functional <br className="hidden md:block" /> mobile apps.
        </h1>
      </FadeIn>
      
      <FadeIn delay={400}>
        <p className="text-lg md:text-3xl text-[#86868b] max-w-4xl leading-relaxed font-medium">
